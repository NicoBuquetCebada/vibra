    ...
    >
      ...
      >
        <Paper
          sx={{
            p: { xs: 0, sm: 2, md: 3 },
            borderRadius: { xs: 0, sm: 3 }, // Sin bordes en móvil, redondeado en desktop
            width: { xs: '100vw', sm: '98%', md: '600px' }, // Ocupa todo el ancho en móvil
            minWidth: 0,
            maxWidth: { xs: '100vw', md: '600px' },
            boxShadow: { xs: 0, sm: 3 }, // Sin sombra en móvil, sombra en desktop
            background: 'linear-gradient(135deg, #f7fafd 0%, #ffffff 100%)',
            border: { xs: 'none', sm: '1px solid rgba(48, 124, 190, 0.08)' },
            mx: 'auto',
          }}
        >
