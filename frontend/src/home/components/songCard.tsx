      ...
      <Card
        ...
        sx={{
          width: largeSize 
            ...
            : mediumSize 
              ? { xs: '95vw', sm: '450px', md: '450px' }
              : { xs: '90vw', sm: '350px', md: '400px' }, // Cambia aquí: más pequeño en xs/sm
          height: largeSize 
            ? { xs: '85vh', md: '720px' }
            : mediumSize 
              ? { xs: '85vh', md: '580px' }
              : { xs: 'auto', sm: '380px', md: '540px' }, // 'auto' en xs
          display: 'flex',
          flexDirection: 'column',
          justifyContent: 'space-between',
          padding: '10px',
          boxShadow: 3,
          borderRadius: { xs: 2, md: 3 }, // Más redondeado en móvil
          position: 'relative',
          overflow: 'hidden',
          cursor: 'pointer',
          margin: { xs: 0, md: '16px' },
          ...
          >
              {song.type === 'album' ? (
                ...
                <Stack
                  ...
                  sx={{
                    position: 'relative',
                    width: largeSize ? '450px' : mediumSize ? '400px' : '350px',
                    height: largeSize ? '450px' : mediumSize ? '400px' : '350px',
                    justifyContent: 'center',
                    alignItems: 'center',
                  }}
                >
                  ...
                  <Box
                    ...
                    sx={{
                      position: 'absolute',
                      width: largeSize ? '420px' : mediumSize ? '370px' : '320px',
                      height: largeSize ? '420px' : mediumSize ? '370px' : '320px',
                      objectFit: 'cover',
                      borderRadius: 2,
                  ...
                  <Box
                    ...
                    sx={{
                      position: 'absolute',
                      width: largeSize ? '430px' : mediumSize ? '380px' : '330px',
                      height: largeSize ? '430px' : mediumSize ? '380px' : '330px',
                      objectFit: 'cover',
                      borderRadius: 2,
                  ...
                  <Box
                    ...
                    sx={{
                      position: 'absolute',
                      width: largeSize ? '440px' : mediumSize ? '390px' : '340px',
                      height: largeSize ? '440px' : mediumSize ? '390px' : '340px',
                      objectFit: 'cover',
                      borderRadius: 2,
                  ...
                  {hover && song.albumSongs && (
                    <Box
                      sx={{
                        position: 'absolute',
                        zIndex: 6,
                        width: largeSize ? '400px' : mediumSize ? '350px' : '300px',
                        height: largeSize ? '400px' : mediumSize ? '350px' : '300px',
                        display: 'flex',
                        flexDirection: 'column',
                        justifyContent: 'center',
                        alignItems: 'center',
                    ...
                    >
                      ...
                      <Box
                        sx={{
                          maxHeight: largeSize ? '300px' : mediumSize ? '250px' : '200px',
                          overflowY: 'auto',
                          width: '100%',
                          '&::-webkit-scrollbar': {
                            width: '4px',
                ...
                <Box
                  ...
                  sx={{
                    width: '100%',
                    maxWidth: largeSize ? '450px' : mediumSize ? '400px' : '350px',
                    aspectRatio: '1/1',
                    objectFit: 'cover',
