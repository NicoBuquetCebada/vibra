  ...
  return (
    <div
      style={{
        ...
        width: '30vw',
        height: '100vh',
        background: 'linear-gradient(135deg, #31384a 60%, #262c36 100%)',
        display: 'flex',
    ...
    >
      ...
      {audio && typeof audio === 'object' && coverImg && (
        <img src={coverImg} alt="cover" style={{ width: '90%', aspectRatio: '1/1', objectFit: 'cover', borderRadius: 12, marginBottom: 18, border: '2px solid #3a7bd5' }} />
      )}
      {audio ? (
        <>
          ...
          {typeof audio === 'object' && (
            <div style={{ color: '#fff', marginTop: 0, background: '#31384a', borderRadius: 8, padding: 12, boxShadow: '0 2px 8px #0003', width: '90%', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
